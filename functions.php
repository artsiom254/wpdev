...
add_action('wp_enqueue_scripts', function (){
    wp_enqueue_style( 'bootstrap_css', get_parent_theme_file_uri( "assets/css/libs/bootstrap.min.css" ) );
    wp_deregister_script( 'jquery-core' );
    wp_register_script( 'jquery-core', get_theme_file_uri('/assets/js/libs/jquery-3.3.1.min.js'), array(), '3.3.1' );
